...
export default function HexNode({
  ...
  const rotation = activeDir ? ARROW_ROTATION[activeDir] : 0;
  ...
  return (
    ...
    >
      <g
        transform={`rotate(${tiltAngle}) scale(${scaleX},${scaleY}) rotate(${-tiltAngle})`}
      >
        <polygon
          points={left}
          fill={palette.left}
